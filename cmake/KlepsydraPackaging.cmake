...
if(${CMAKE_BUILD_TYPE} STREQUAL "RelWithDebInfo")
    set(CPACK_RPM_LIBS_DEBUGINFO_PACKAGE TRUE)
endif()
...
if(${CMAKE_BUILD_TYPE} STREQUAL "RelWithDebInfo")
    set(CPACK_DEBIAN_LIBS_DEBUGINFO_PACKAGE TRUE)
endif()
...
if(KPSR_PACKAGE_OPTIONS)
    set(CPACK_DEBIAN_LIBS_PACKAGE_PROVIDES
        "${CMAKE_PROJECT_NAME} (=${KPSR_VERSION})")
    set(CPACK_DEBIAN_DEV_PACKAGE_PROVIDES
        "${CMAKE_PROJECT_NAME}-dev (=${KPSR_VERSION})")
    set(CPACK_DEBIAN_DOCS_PACKAGE_PROVIDES
        "${CMAKE_PROJECT_NAME}-doc (=${KPSR_VERSION})")
    set(CPACK_DEBIAN_TESTS_PACKAGE_PROVIDES
        "${CMAKE_PROJECT_NAME}-tests (=${KPSR_VERSION})")
    set(CPACK_DEBIAN_EXAMPLES_PACKAGE_PROVIDES
        "${CMAKE_PROJECT_NAME}-examples (=${KPSR_VERSION})")
    set(CPACK_DEBIAN_LIBS_PACKAGE_CONFLICTS "${CMAKE_PROJECT_NAME}")
    set(CPACK_DEBIAN_DEV_PACKAGE_CONFLICTS "${CMAKE_PROJECT_NAME}-dev")
    set(CPACK_DEBIAN_DOCS_PACKAGE_CONFLICTS "${CMAKE_PROJECT_NAME}-doc")
    set(CPACK_DEBIAN_TESTS_PACKAGE_CONFLICTS "${CMAKE_PROJECT_NAME}-tests")
    set(CPACK_DEBIAN_EXAMPLES_PACKAGE_CONFLICTS
